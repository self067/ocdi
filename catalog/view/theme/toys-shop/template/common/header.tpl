...
<noscript><div><img src="https://mc.yandex.ru/watch/52677457" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<!--                     <li class="nav-item">
                        <a href="<?php echo $newsblog;?>" class="nav-link">News</a>
                     </li> -->
